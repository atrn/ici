...
{
    return ptrof(o1)->p_aggr != ptrof(o2)->p_aggr || ptrof(o1)->p_key != ptrof(o2)->p_key;
}
...
{
    return (unsigned long)ptrof(o)->p_aggr * PTR_PRIME_0 + (unsigned long)ptrof(o)->p_key * PTR_PRIME_1;
}
