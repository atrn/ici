 ...
 */
extern struct tag_with_incref
{
} with_incref;
extern struct tag_with_decref
{
} with_decref;
...
inline objwsup *objwsupof(object *o)
{
    return o->as<objwsup>();
}
 ...
 */
inline bool hassuper(const object *o)
{
    return o->hasflag(object::O_SUPER);
}
...
constexpr uint8_t TC_VEC32F = 27;
constexpr uint8_t TC_VEC64F = 28;
