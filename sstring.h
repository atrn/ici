...
SSTRING(fork, "fork")
SSTRING(vec, "vec")
SSTRING(vec32f, "vec32f")
SSTRING(vec64f, "vec64f")
SSTRING(fsize, "fsize")
SSTRING(func, "func")
SSTRING(gecos, "gecos")
SSTRING(get, "get")
