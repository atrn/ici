...
#define PUBLIC_OPTIONS                                                                                                 \
    (PCRE_CASELESS | PCRE_EXTENDED | PCRE_ANCHORED | PCRE_MULTILINE | PCRE_DOTALL | PCRE_DOLLAR_ENDONLY | PCRE_EXTRA | \
     PCRE_UNGREEDY)
...
typedef struct real_pcre
{
    ...
    uschar               req_char;
    /* ICI */
    size_t size; /* Size of code vector - used in GC mark/sweep */
    /* ICI */
    uschar code[1];
} real_pcre;
