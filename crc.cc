 ...
 * some hash functions.
 */
unsigned long const ici_crc_table[256] =
{
...
/*
 * Calculate a 32 bit CRC checksum of a buffer of bytes.  Start by passing in
 * a start value.  This gives really good hash functions.  But it has to
 * access the above table to do it.  Cache misses on this table are really
