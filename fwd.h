...
extern int                      ici_method(object *, ici_str_t *, const char *, ...);
...
extern object        *ici_evaluate(object *, int);
...
extern ici_sslot_t      *ici_find_raw_slot(ici_struct_t *, object *);
extern object        *ici_atom_probe2(object *, object ***);
extern int              ici_parse_exec();
extern ici_parse_t      *ici_new_parse(ici_file_t *);
extern ici_catch_t      *ici_new_catch(object *, int, int, int);
extern ici_func_t       *ici_new_func();
extern ici_op_t         *ici_new_op(int (*)(), int16_t, int16_t);
