...
extern void             ici_uninit_cfunc(void);
extern int              ici_exec_forall(void);
extern int              ici_compile_expr(ici_array_t *, expr_t *, int);
extern void             ici_uninit_compile(void);
